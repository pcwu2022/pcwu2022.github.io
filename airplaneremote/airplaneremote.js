...
let tiltSense = function(){
    // screen.orientation.lock("orientation");
    let deviceOrientationListener = function(e){ 
        gy = round(e.beta);
        gz = round(e.gamma);
        interact("updown="+gy);
...
let tilt = function(){
    ...
    stroke(0,0,0);
    fill(100,100,100);
    let slidebar = rect(85,20,30,220);
    fill(200,200,200);
    let slider = rect(75,220,50,20);
